...
import 'package:flutter_hyphenate/src/service/error_reporting.dart';
import 'package:flutter_hyphenate/src/widget/hyphen_paragraph.dart';
import 'package:flutter_hyphenate/src/widget/hyphen_scope.dart';
...
class HyphenText extends Text {
  ...
  Widget build(BuildContext context) {
    ...
    ensureFlutterHyphenateErrorReporting();
